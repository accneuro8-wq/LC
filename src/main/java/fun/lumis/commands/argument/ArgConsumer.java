...
package fun.lumis.commands.argument;
...
import fun.lumis.utils.client.managers.api.command.datatypes.IDatatype;
import fun.lumis.utils.client.managers.api.command.datatypes.IDatatypeContext;
import fun.lumis.utils.client.managers.api.command.datatypes.IDatatypeFor;
import fun.lumis.utils.client.managers.api.command.datatypes.IDatatypePost;
import fun.lumis.utils.client.managers.api.command.exception.CommandException;
import fun.lumis.utils.client.managers.api.command.exception.CommandInvalidTypeException;
import fun.lumis.utils.client.managers.api.command.exception.CommandNotEnoughArgumentsException;
import fun.lumis.utils.client.managers.api.command.exception.CommandTooManyArgumentsException;
import fun.lumis.utils.client.managers.api.command.manager.ICommandManager;
