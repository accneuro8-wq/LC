...
import fun.lumis.utils.client.managers.api.command.exception.CommandNotFoundException;
...
import fun.lumis.events.chat.ChatEvent;
import fun.lumis.events.chat.TabCompleteEvent;
...
public class CommandDispatcher implements QuickLogger {
    ...
    public CommandDispatcher(EventManager eventManager) {
        this.manager = lumis.getInstance().getCommandRepository();
