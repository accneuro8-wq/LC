...
package fun.lumis.commands.argparser;

import fun.lumis.utils.client.managers.api.command.argparser.IArgParser;
...
import fun.lumis.utils.client.managers.api.command.exception.CommandNoParserForTypeException;
