package fun.lumis.commands.manager;
...
import fun.lumis.utils.client.managers.api.command.exception.CommandUnhandledException;
import fun.lumis.utils.client.managers.api.command.exception.ICommandException;
...
import fun.lumis.commands.argument.ArgConsumer;
import fun.lumis.commands.argument.CommandArguments;
import fun.lumis.commands.defaults.DefaultCommands;
    ...
    public Stream<String> tabComplete(String prefix) {
        ...
        if (args.isEmpty()) {
            return new TabCompleteHelper()
                    .addCommands(lumis.getInstance().getCommandRepository())
                    .filterPrefix(label)
                    .stream();
        } else {
