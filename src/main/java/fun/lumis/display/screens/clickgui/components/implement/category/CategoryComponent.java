package fun.lumis.display.screens.clickgui.components.implement.category;
...
import fun.lumis.common.animation.implement.InOutBack;
import fun.lumis.utils.display.font.Fonts;
import fun.lumis.utils.display.shape.ShapeProperties;
import fun.lumis.display.screens.clickgui.components.implement.module.ModuleComponent;
...
public class CategoryComponent extends AbstractComponent {
    ...
    private void initializeModules() {
        List<Module> modules = lumis.getInstance()
                .getModuleRepository()
                .modules();
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        for (int i = moduleComponents.size() - 1; i >= 0; i--) {
            ...
            if (shouldRenderComponent(component)) {
                int componentHeight = component.getComponentHeight() + 11;
                ...
                component.width = columnWidth + 42;
    ...
    private void drawCategoryTab(DrawContext context, MatrixStack matrix, int mouseX, int mouseY) {
        ...
        if (ModuleCategory.COMBAT.equals(category)) {
            Fonts.getSize(21, Fonts.Type.ICONSCATEGORY).drawCenteredString(context.getMatrices(), "b", x + 16f, y + 8.5f, ColorAssist.getText());
        }
        if (ModuleCategory.MOVEMENT.equals(category)) {
            Fonts.getSize(23, Fonts.Type.ICONSCATEGORY).drawCenteredString(context.getMatrices(), "c", x + 15f, y + 7.5f, ColorAssist.getText());
        }
        if (ModuleCategory.RENDER.equals(category)) {
            Fonts.getSize(21, Fonts.Type.ICONSCATEGORY).drawCenteredString(context.getMatrices(), "d", x + 15f, y + 7.5f, ColorAssist.getText());
        }
        if (ModuleCategory.PLAYER.equals(category)) {
            Fonts.getSize(23, Fonts.Type.ICONSCATEGORY).drawCenteredString(context.getMatrices(), "e", x + 15f, y + 7.5f, ColorAssist.getText());
        }
