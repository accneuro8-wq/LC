...
public class SearchComponent extends AbstractComponent {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        rectangle.render(ShapeProperties.create(matrix, x + width - 14f, y + 3.5f, 0.5f, height - 7)
                .color(new Color(155, 155, 155, 55).getRGB()).build());

        Fonts.getSize(20, Fonts.Type.ICONS).drawString(context.getMatrices(), "U", x + width - 12f, y + 3.5f, typing ? -1 : 0xFF878894);
