package fun.lumis.display.screens.clickgui.components.implement.window.implement.settings.color;
...
import fun.lumis.display.screens.clickgui.components.implement.window.implement.settings.color.component.*;
