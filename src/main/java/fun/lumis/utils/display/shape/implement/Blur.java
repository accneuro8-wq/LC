...
public class Blur implements Shape, QuickImports {
    ...
    public void render(ShapeProperties shape) {
        ...
        float blurAlpha = alpha * 0.9f;
        shader.getUniformOrDefault("color1").set(ColorAssist.redf(shape.getColor().x), ColorAssist.greenf(shape.getColor().x), ColorAssist.bluef(shape.getColor().x), blurAlpha);
        shader.getUniformOrDefault("color2").set(ColorAssist.redf(shape.getColor().y), ColorAssist.greenf(shape.getColor().y), ColorAssist.bluef(shape.getColor().y), blurAlpha);
        shader.getUniformOrDefault("color3").set(ColorAssist.redf(shape.getColor().z), ColorAssist.greenf(shape.getColor().z), ColorAssist.bluef(shape.getColor().z), blurAlpha);
        shader.getUniformOrDefault("color4").set(ColorAssist.redf(shape.getColor().w), ColorAssist.greenf(shape.getColor().w), ColorAssist.bluef(shape.getColor().w), blurAlpha);
