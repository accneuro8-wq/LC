package fun.lumis.utils.display.atlasfont.msdf;
...
import fun.lumis.utils.display.atlasfont.msdf.FontData.AtlasData;
import fun.lumis.utils.display.atlasfont.msdf.FontData.MetricsData;
