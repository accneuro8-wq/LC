...
import fun.lumis.utils.display.font.entry.DrawEntry;
import fun.lumis.utils.display.font.glyph.Glyph;
import fun.lumis.utils.display.font.glyph.GlyphMap;
...
import fun.lumis.events.render.TextFactoryEvent;
...
public class FontRenderer implements QuickImports {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("lumis", "temp/" + StringHelper.randomString(32));
    }
