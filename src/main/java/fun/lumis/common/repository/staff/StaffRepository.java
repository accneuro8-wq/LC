package fun.lumis.common.repository.staff;

import fun.lumis.lumis;
import fun.lumis.utils.client.managers.file.FileController;
import fun.lumis.utils.client.managers.file.impl.StaffFile;
...
public class StaffRepository {
    ...
    private static void save() {
        FileController fileController = lumis.getInstance().getFileController();
