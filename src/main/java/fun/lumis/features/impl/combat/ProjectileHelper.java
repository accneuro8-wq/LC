...
import fun.lumis.common.repository.friend.Friend;
...
import fun.lumis.utils.features.aura.warp.TurnsConstructor;
    ...
    public void onRotationUpdate(RotationUpdateEvent e) {
        ...
        if (currentTarget != null) {
            ...
            TurnsConnection.INSTANCE.rotateTo(
                    new Turns(yaw, pitch),
                    TurnsConfig.DEFAULT,
                    fun.lumis.utils.math.task.TaskPriority.HIGH_IMPORTANCE_1,
                    this
            );
        }
    }
